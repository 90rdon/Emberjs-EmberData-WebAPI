...
function GetDebtorUrl(clientId) {
    var url = "http://crmtitaniuminterface.hunterwarfield.com?clientid=" + clientId + "&caneditdebtor=" + canEditDebtor;
